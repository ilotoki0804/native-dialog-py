...
mod _native_dialog {
    ...
    #[pyfunction]
    fn async_support() -> bool {
        cfg!(feature = "async")
    }

    #[cfg(feature = "async")]
    #[pyfunction]
    async fn async_confirm(title: String, text: String, level: &str) -> PyResult<bool> {
        let dialog = message_dialog(title, text, level)?.confirm();
        to_python_result(dialog.spawn().await)
    }

    #[cfg(feature = "async")]
    #[pyfunction]
    async fn async_alert(title: String, text: String, level: &str) -> PyResult<()> {
        let dialog = message_dialog(title, text, level)?.alert();
        to_python_result(dialog.spawn().await)
    }
    ...
    #[cfg(feature = "async")]
    #[pyfunction]
    async fn async_open_multiple_files(
        filename: Option<String>,
        location: Option<PathBuf>,
        title: String,
        filters: Option<Filters>,
    ...
    #[cfg(feature = "async")]
    #[pyfunction]
    async fn async_open_single_dir(
        filename: Option<String>,
        location: Option<PathBuf>,
        title: String,
    ) -> PyResult<Option<PathBuf>> {
    ...
    #[cfg(feature = "async")]
    #[pyfunction]
    async fn async_open_single_file(
        filename: Option<String>,
        location: Option<PathBuf>,
        title: String,
        filters: Option<Filters>,
    ...
    #[cfg(feature = "async")]
    #[pyfunction]
    async fn async_save_single_file(
        filename: Option<String>,
        location: Option<PathBuf>,
        title: String,
        filters: Option<Filters>,
